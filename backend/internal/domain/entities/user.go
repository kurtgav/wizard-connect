...
type User struct {
	...
	Gender           string    `json:"gender" db:"gender"`                         // male, female, non-binary, prefer_not_to_say, other
	GenderPreference string    `json:"gender_preference" db:"gender_preference"`   // male, female, both
